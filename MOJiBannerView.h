...
@property (nonatomic, assign) BOOL hidePageContol;      // 是否隐藏pageControl, 默认为NO，展示
 ...
 */
- (void)selectBannerView:(MOJiBannerView *)bannerView currentPage:(NSInteger)currentPage;
